...
def start_game():
    ...
    #agent = DQNAgent(player=PLAYER1 if first_turn else PLAYER2)
    
    # Log initialization for debugging
    print("Agent initialized in /start with player:", "PLAYER1" if first_turn else "PLAYER2")
...
def make_move():
    ...
    move = agent.get_best_move(game)
    print("Move generated by agent:", move)
    ###################
